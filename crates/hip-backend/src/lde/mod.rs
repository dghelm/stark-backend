//! Low Degree Extension (LDE) module for HIP backend.
//!
//! This module provides GPU-accelerated LDE computation using HIP kernels.
//! The LDE is used for polynomial commitment schemes in STARK proofs.
