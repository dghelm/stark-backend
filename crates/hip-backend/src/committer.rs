//! Trace commitment module for HIP backend.
//!
//! This module provides GPU-accelerated trace commitment using LDE and Merkle trees.

use openvm_stark_backend::prover::hal::MatrixDimensions;
use p3_baby_bear::BabyBear;
use p3_util::log2_strict_usize;

use crate::{base::DeviceMatrix, hip_device::HipDevice, lde::GpuLde, merkle_tree::GpuMerkleTree};
