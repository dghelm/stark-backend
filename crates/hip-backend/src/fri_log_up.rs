...
impl FriLogUpPhaseGpu {
    ...
    pub fn partially_prove_gpu(
        ...
        let (after_challenge_trace_per_air, cumulative_sum_per_air) = self
            .generate_after_challenge_traces_per_air_gpu(
                &challenges,
                constraints_per_air,
                params_per_air,
                trace_view_per_air,
