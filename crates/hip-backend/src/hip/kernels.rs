//! HIP kernel bindings.
//!
//! These bindings use the same extern "C" signatures as the CUDA backend since
//! the kernel sources are shared and use __HIPCC__ guards for HIP compatibility.
...
pub mod matrix {
    ...
    pub unsafe fn matrix_transpose<T>(
        ...
        HipError::from_result_i32(result).map_err(KernelError::from)
    }
    ...
    pub unsafe fn split_ext_poly_to_multiple_base_matrix<EF>(
        ...
        HipError::from_result_i32(_split_ext_poly_to_multiple_base_matrix(
    ...
    pub unsafe fn matrix_get_rows_fp_kernel<F>(
        ...
        HipError::from_result_i32(_matrix_get_rows_fp(
...
pub mod lde {
    ...
    pub unsafe fn batch_bit_reverse<T>(
        ...
        HipError::from_result_i32(_multi_bit_reverse(io.as_mut_raw_ptr(), n_bits, count))
    }
    ...
    pub unsafe fn zk_shift<T>(
        ...
        HipError::from_result_i32(_zk_shift(io.as_mut_raw_ptr(), io_size, log_n, shift))
    }
    ...
    pub unsafe fn batch_expand_pad<T>(
        ...
        HipError::from_result_i32(_batch_expand_pad(
            output.as_mut_raw_ptr(),
            input.as_raw_ptr(),
            poly_count,
            out_size,
...
pub mod poseidon2 {
    ...
    pub unsafe fn poseidon2_compress<T>(
        ...
        HipError::from_result_i32(_poseidon2_compress(
            output.as_mut_raw_ptr(),
            input.as_raw_ptr(),
            output_size,
            is_inject,
    ...
    pub unsafe fn query_digest_layers_kernel<T>(
        ...
        HipError::from_result_i32(_query_digest_layers(
...
pub mod quotient {
    ...
    pub unsafe fn quotient_selectors<F>(
        ...
        HipError::from_result_i32(_cukernel_quotient_selectors(
    ...
    pub unsafe fn quotient_global_or_local<F, EF, R>(
        ...
        HipError::from_result_i32(_cukernel_quotient(
            is_global,
...
pub mod prefix {
    ...
    pub unsafe fn prefix_scan_block_ext<T>(
        ...
        HipError::from_result_i32(_prefix_scan_block_ext(
    ...
    pub unsafe fn prefix_scan_block_downsweep_ext<T>(
        ...
        HipError::from_result_i32(_prefix_scan_block_downsweep_ext(
            d_inout.as_mut_raw_ptr(),
            length,
            round_stride,
        ))
    ...
    pub unsafe fn prefix_scan_epilogue_ext<T>(
        ...
        HipError::from_result_i32(_prefix_scan_epilogue_ext(d_inout.as_mut_raw_ptr(), length))
    }
}
...
pub mod permute {
    ...
    pub unsafe fn calculate_cumulative_sums<F, EF, R>(
        ...
        HipError::from_result_i32(_calculate_cumulative_sums(
            is_global,
    ...
    pub unsafe fn permute_update<F, EF>(
        ...
        HipError::from_result_i32(_permute_update(
...
pub mod fri {
    ...
    pub unsafe fn diffs_kernel<F, EF>(
        ...
        HipError::from_result_i32(_compute_diffs(
    ...
    pub unsafe fn batch_invert_kernel<EF>(
        ...
        HipError::from_result_i32(_batch_invert(
            d_diffs.as_mut_raw_ptr(),
            log_max_height,
            invert_task_num,
        ))
    ...
    pub unsafe fn powers<F>(
        ...
        HipError::from_result_i32(_powers(d_data.as_mut_raw_ptr(), g, n))
    }
    ...
    pub unsafe fn powers_ext<EF>(
        ...
        HipError::from_result_i32(_powers_ext(d_data.as_mut_raw_ptr(), g, n))
    }
    ...
    pub unsafe fn reduce_matrix_quotient_kernel<F, EF>(
        ...
        HipError::from_result_i32(_reduce_matrix_quotient_acc(
    ...
    pub unsafe fn split_ext_poly_to_base_col_major_matrix<F, EF>(
        ...
        HipError::from_result_i32(_cukernel_split_ext_poly_to_base_col_major_matrix(
    ...
    pub unsafe fn fri_fold_kernel<F, EF>(
        ...
        HipError::from_result_i32(_cukernel_fri_fold(
    ...
    pub unsafe fn matrix_evaluate_chunked_kernel<F, EF>(
        ...
        HipError::from_result_i32(_matrix_evaluate_chunked(
    ...
    pub unsafe fn matrix_evaluate_finalize_kernel<EF>(
        ...
        HipError::from_result_i32(_matrix_evaluate_finalize(
            output.as_mut_raw_ptr(),
